...
public class test {
	...
	@Test
	public void testToStringFilm() throws wrongDateExeption {
		Saal gruenerSaal = new Saal("Gruener Saal", 200);
		Film barbie = new Film("Barbie - Die Prinzessinnen-Akademie",
		        " 81 min", Rating.AB_0 , new Zeit(
		                15, 00), gruenerSaal);
		assertEquals("15:00 -- Barbie - Die Prinzessinnen-Akademie"  + Rating.AB_0  + " 81 min",
		        barbie.toString());
		
	
			Saal blauerSaal = new Saal("Blauer Saal", 250);
			Film batman  = new Film("Batman Begins",
			        " 134 min", Rating.AB_12 , new Zeit(
			                "14:00"), blauerSaal);
